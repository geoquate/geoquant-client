import 'package:geoquate_ui/geoquate_ui.dart';
import 'package:geoquate/ui/address_selection/address_selection_view.form.dart';
      ...
      builder: (context, model, child) => Scaffold(
        ...
        body: ListView(
          ...
          children: [
            ...
            verticalSpaceMedium,
            if (model.hasAddress && model.addressValue!.isEmpty)
